      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-500 text-white rounded-xl px-8 py-4 font-medium transition-all flex items-center justify-center gap-2 group"
            >
              Send Message
